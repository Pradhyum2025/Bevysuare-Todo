...
const NoteEditor = ({ todo }) => {
  ...
  const [title, setTitle] = useState(todo?.title || "Undefined");
  ...
  return (
    <div className="bg-white p-6 rounded shadow-lg max-w-4xl mx-auto relative">
       
       {/* Auto Save */}
      <div className='my-2'>
        {saving ?
          <div role="status">
            <svg aria-hidden="true" class="w-[20px] h-[20px] text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div
        ...
        ref={contentRef}
        onInput={handleInput}
        className="py-4 min-h-[100px] rounded text-gray-700 outline-none text-[18px] font-[400]"
